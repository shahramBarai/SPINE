...
var require_httpErrors = __commonJS({
  "node_modules/.pnpm/@fastify+sensible@6.0.3/node_modules/@fastify/sensible/lib/httpErrors.js"(exports2, module2) {
    "use strict";
    ...
    module2.exports = httpErrors;
    module2.exports.getHttpError = getHttpError;
    module2.exports.HttpError = createError.HttpError;
...
var require_assert = __commonJS({
  "node_modules/.pnpm/@fastify+sensible@6.0.3/node_modules/@fastify/sensible/lib/assert.js"(exports2, module2) {
    "use strict";
...
var require_vary2 = __commonJS({
  "node_modules/.pnpm/@fastify+sensible@6.0.3/node_modules/@fastify/sensible/lib/vary.js"(exports2, module2) {
    "use strict";
...
var require_cache_control = __commonJS({
  "node_modules/.pnpm/@fastify+sensible@6.0.3/node_modules/@fastify/sensible/lib/cache-control.js"(exports2, module2) {
    "use strict";
...
var require_sensible = __commonJS({
  "node_modules/.pnpm/@fastify+sensible@6.0.3/node_modules/@fastify/sensible/index.js"(exports2, module2) {
    "use strict";
    ...
    module2.exports = fp(fastifySensible, {
      name: "@fastify/sensible",
      fastify: "5.x"
    });
    module2.exports.default = fastifySensible;
    module2.exports.fastifySensible = fastifySensible;
    module2.exports.httpErrors = httpErrors;
    module2.exports.HttpError = httpErrors.HttpError;
  }
});
...
var import_sensible = __toESM(require_sensible());
...
var configSchema = import_zod.z.object({
  port: import_zod.z.string().default("3002").transform(Number),
  host: import_zod.z.string().default("0.0.0.0"),
  kafka: import_zod.z.object({
    brokers: import_zod.z.string().transform((val) => val.split(",")),
    clientId: import_zod.z.string().default("kafka-rest-service"),
    connectionTimeout: import_zod.z.string().default("10000").transform(Number),
    requestTimeout: import_zod.z.string().default("30000").transform(Number),
    retry: import_zod.z.object({
      retries: import_zod.z.string().default("5").transform(Number)
    })
  }),
  logLevel: import_zod.z.enum(["fatal", "error", "warn", "info", "debug", "trace"]).default("info"),
  cors: import_zod.z.object({
    origin: import_zod.z.string().default("http://localhost:3000")
  })
});
var env = {
...
var config = configSchema.parse(env);
...
// src/services/kafkaAdmin.ts
var import_kafkajs = require("kafkajs");
var KafkaAdminService = class {
  kafka;
  admin;
  constructor() {
  ...
  async getTopicConfiguration(topicName) {
    try {
      const configs = await this.admin.describeConfigs({
        includeSynonyms: false,
        resources: [
          {
            type: import_kafkajs.ConfigResourceTypes.TOPIC,
            name: topicName
          }
        ]
      });
...
var topicsRoutes = async (fastify) => {
  const kafkaAdmin = new KafkaAdminService();
  await kafkaAdmin.connect();
  ...
  fastify.post(
    ...
    async (request, reply) => {
      try {
        const { topic, numPartitions, replicationFactor, configEntries } = request.body;
        const topicConfig = {
          topic,
          numPartitions,
          replicationFactor,
        ...
        return {
          success: result,
          message: result ? `Topic '${topic}' created successfully` : `Topic '${topic}' already exists`
        };
      } catch (error) {
  ...
  fastify.get(
    ...
    async (request, _reply) => {
      try {
        const { topic } = request.params;
        const config2 = await kafkaAdmin.getTopicConfiguration(topic);
...
var clusterRoutes = async (fastify) => {
  const kafkaAdmin = new KafkaAdminService();
  await kafkaAdmin.connect();
  fastify.addHook("onClose", async () => {
    await kafkaAdmin.disconnect();
...
var buildServer = async () => {
  ...
  await fastify.register(import_sensible.default);
