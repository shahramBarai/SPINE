...
export type RegisterSchemaResponse = z.infer<
    typeof registerSchemaResponseSchema
>;
export type CompatibilityCheckResponse = z.infer<
    typeof compatibilityCheckResponseSchema
>;
