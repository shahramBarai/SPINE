            ...
            <div className="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        >
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="BACKWARD_TRANSITIVE">
                                    BACKWARD_TRANSITIVE
                                </SelectItem>
                                <SelectItem value="FORWARD_TRANSITIVE">
                                    FORWARD_TRANSITIVE
                                </SelectItem>
                                <SelectItem value="FULL_TRANSITIVE">
                                    FULL_TRANSITIVE
                                </SelectItem>
                            </SelectContent>
                        </Select>
                    ...
                    <div className="mt-2 text-xs text-gray-500">
                        <p>
                            Current compatibility level affects how schema
                            evolution is validated.
                        </p>
                    </div>
                </div>
