        ...
        <div className="p-6">
            ...
            <div className="bg-primary/10 border border-primary/20 rounded-lg p-6 mb-6">
                ...
                <p className="text-muted-foreground">
                    ...
                    privileges. Here you can manage user accounts, assign roles,
                    and configure access permissions.
                </p>
            </div>
...
const UserManagementPage = adminGuard(UserManagementPageContent);
