...
export function DevSignInForm() {
    ...
    const devSignIn = api.auth.devSignIn.useMutation({
        onSuccess: (data) => {
            utils.auth.getSession.setData(undefined, data);
        },
        onError: (error) => {
                    ...
                    <div className="mt-8 space-y-4">
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            <p className="text-sm text-yellow-800">
                                <strong>⚠️ Development Mode:</strong> These
                                accounts are auto-created with default password
                                &quot;dev123456&quot;. This feature is only
