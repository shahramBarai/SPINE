"""
name: ttl_ifc_system_link.py
description: Link IFC system instances with HVAC TTL files. Link HVAC elements to spaces based on spatial intersections and save the enriched graph.
"""
...
def link_mep_system_ttl(mep_ifc_folder, mep_ttl_folder, arc_ifc_path, arc_ttl, mep_ifc_types, save_path):
    ...
    save_graph(graph_systems, save_path)
